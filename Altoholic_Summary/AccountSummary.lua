...
--	if showRecipeStats then	-- for primary skills + cooking
...
columns["CurrencyOrderHall"] = {
	-- Header
	headerWidth = 80,
	headerLabel = "        " .. format(TEXTURE_FONT, "Interface\\Icons\\inv_orderhall_orderresources", 18, 18),
	headerOnEnter = function(frame, tooltip)
...
--	[MODE_ARTIFACT] = { "Name", "Level", "ArtifactRank", "ArtifactPower" },
}
