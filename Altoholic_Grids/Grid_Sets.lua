...
local TransmogSets = {
  ...
  {	-- [5] Mists of Pandaria
    ...
    { setID = 1443 }, -- MoP Challenge Modes
  ...
  {	-- [7] Legion
    ...
    { setID = 1471 },             -- Seat of the Triumverate
    ...
    { setID = 174 },			-- Trial of Valor
    { setID = 172 },			-- Trial of Valor
    { setID = 171 },			-- Trial of Valor
    { setID = 173 },			-- Trial of Valor
    ...
    { setID = 1491, tier = 21 },      -- Antorus, The Burning Throne
    { setID = 1488, tier = 21 },      -- Antorus, The Burning Throne
    { setID = 1489, tier = 21 },      -- Antorus, The Burning Throne
    { setID = 1490, tier = 21 },      -- Antorus, The Burning Throne
    ...
    { setID = 1364, tier = "23+24+25", isPVP = true }, -- Legion Season 5, 6, and 7 A
    { setID = 1365, tier = "23+24+25", isPVP = true }, -- Legion Season 5, 6, and 7 H
    { setID = 1408, tier = "23+24+25", isPVP = true }, -- Legion Season 5, 6, and 7 A
    { setID = 1409, tier = "23+24+25", isPVP = true }, -- Legion Season 5, 6, and 7 H
    { setID = 1384, tier = "23+24+25", isPVP = true }, -- Legion Season 5, 6, and 7 A
    { setID = 1385, tier = "23+24+25", isPVP = true }, -- Legion Season 5, 6, and 7 H
  },
  { -- [8] Battle for Azeroth
    { setID = 1637 },       -- Shrine of the Storm
    { setID = 1641 },       -- Uldir LFR
    { setID = 1638 },       -- Uldir N
    { setID = 1639 },       -- Uldir H
    { setID = 1640 },       -- Uldir M
    { setID = 1655, tier = "26", isPVP = true }, -- Battle Season 1 & Arathi Warfront A Aspirant
    { setID = 1667, tier = "26", isPVP = true }, -- Battle Season 1 & Arathi Warfront H Aspirant
    { setID = 1656, tier = "26", isPVP = true }, -- Battle Season 1 & Arathi Warfront A Warfront
    { setID = 1668, tier = "26", isPVP = true }, -- Battle Season 1 & Arathi Warfront H Warfront
    { setID = 1654, tier = "26", isPVP = true }, -- Battle Season 1 & Arathi Warfront A Gladiator
    { setID = 1666, tier = "26", isPVP = true }, -- Battle Season 1 & Arathi Warfront H Gladiator
    { setID = 1738, tier = "26", isPVP = true }, -- Battle Season 1 & Arathi Warfront A Gladiator Elite
    { setID = 1734, tier = "26", isPVP = true }, -- Battle Season 1 & Arathi Warfront H Gladiator Elite
  },
}
